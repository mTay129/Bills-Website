...
@app.route('/why')
def why():
    return render_template('why.html', active_page='why')

@app.route('/approach')
def approach():
    return render_template('approach.html', active_page='approach')
...
@app.route('/cause')
def cause():
    return render_template('cause.html', active_page='cause')
...
# Hidden pages not on navigation bar
@app.route('/privacy')
def privacy():
